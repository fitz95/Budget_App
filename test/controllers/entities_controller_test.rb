...
class EntitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entity" do
    assert_difference("Entity.count") do
      post entities_url, params: { entity: { AuthorID: @entity.AuthorID, amount: @entity.amount, name: @entity.name } }
    end
  ...
  test "should update entity" do
    patch entity_url(@entity), params: { entity: { AuthorID: @entity.AuthorID, amount: @entity.amount, name: @entity.name } }
